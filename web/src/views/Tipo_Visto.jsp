<%-- 
    Document   : Tipo_Visto
    Created on : Jun 4, 2019, 10:42:35 AM
    Author     : hskodama
--%>
...
<html>
    ...
    <body>
        ...
        <div class="tipo_margin">
            ...
            <div class="content">
                <p>Destina-se a estrangeiros de passagem pelo Brasil, com destino a outro país. Através deste é permitida ao viajante estrangeiro ausentar-se da área de trânsito do aeroporto. Permite um único ingresso no território brasileiro de no máximo 10 ( dez dias ) improrrogáveis.</p>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <div class="tipo_margin_aninhado">
                    <button class="collapsible">Estudante</button>
                      <div class="content">
                        <p>Destina-se a estudantes de cursos regulares como ensino fundamental, médio, superior ou pós-graduação. Possui validade de até 1 ano, podendo ser prorrogado por igual período, por sucessivas vezes, enquanto durar o curso. O pedido de prorrogação deve ser solicitado junto ao Departamento de Policia Federal ou no Protocolo Geral do Ministério da Justiça, em até 30 (trinta) dias antes do término da estadia. Aos portadores de visto de estudante é vedado o exercício de atividade remunerada, sob pena de multa, notificação ou ainda deportação.</p>
                      </div>
                </div>
                ...
                <div class="tipo_margin_aninhado">
                    <button class="collapsible">Jornalista</button>
                      <div class="content">
                        <p>Destina-se a jornalistas remunerados por empresas estrangeiras. O visto autoriza a estadia por no máximo 4 (quatro)anos, podendo ser prorrogada por igual período, mediante requerimento ao Ministério da Justiça, antes do vencimento do mesmo.</p>
                      </div>
                </div>
